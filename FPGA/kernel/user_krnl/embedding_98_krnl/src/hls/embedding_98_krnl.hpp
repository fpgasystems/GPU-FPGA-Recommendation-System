...
const int depth_s_embedding_buffer_PLRAM17 = VECTOR_SIZE_PLRAM_BANK_16 * FIFO_BATCH_SIZE;
const int depth_s_embedding_buffer_PLRAM18 = VECTOR_SIZE_PLRAM_BANK_16 * FIFO_BATCH_SIZE;
