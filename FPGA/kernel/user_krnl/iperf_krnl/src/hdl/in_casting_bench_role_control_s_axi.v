...
localparam
    ...
    ADDR_IER                           = 8'h08,
    ADDR_ISR                           = 8'h0c,
    ADDR_USECONN_DATA_0                = 8'h10,
    ADDR_USECONN_CTRL                  = 8'h14,
    ADDR_USEIPADDR_DATA_0              = 8'h18,
    ADDR_USEIPADDR_CTRL                = 8'h1c,
    ADDR_PKGWORDCOUNT_DATA_0           = 8'h20,
    ADDR_PKGWORDCOUNT_CTRL             = 8'h24,
    ADDR_BASEPORT_DATA_0               = 8'h28,
    ADDR_BASEPORT_CTRL                 = 8'h2c,
    ADDR_USEPORT_DATA_0                = 8'h30,
    ADDR_USEPORT_CTRL                  = 8'h34,
    ADDR_EXPECTEDRESPINKBPERCON_DATA_0 = 8'h38,
    ADDR_EXPECTEDRESPINKBPERCON_CTRL   = 8'h3c,
    ADDR_DELAYEDCYCLES_DATA_0          = 8'h40,
    ADDR_DELAYEDCYCLES_CTRL            = 8'h44,
    ADDR_BASEIPADDRESS_DATA_0          = 8'h48,
    ADDR_BASEIPADDRESS_CTRL            = 8'h4c,
    ADDR_EXPECTEDRESPINKBTOTAL_DATA_0  = 8'h50,
    ADDR_EXPECTEDRESPINKBTOTAL_CTRL    = 8'h54,
    ADDR_CLIENTPKGNUM_DATA_0           = 8'h58,
    ADDR_CLIENTPKGNUM_CTRL             = 8'h5c,
    ADDR_DUALMODEEN_DATA_0             = 8'h60,
    ADDR_DUALMODEEN_CTRL               = 8'h64,
    ADDR_PACKETGAP_DATA_0              = 8'h68,
    ADDR_PACKETGAP_CTRL                = 8'h6c,
    ADDR_TIMEINSECONDS_DATA_0          = 8'h70,
    ADDR_TIMEINSECONDS_CTRL            = 8'h74,
    ADDR_TIMEINCYCLES_DATA_0           = 8'h78,
    ADDR_TIMEINCYCLES_DATA_1           = 8'h7c,
    ADDR_TIMEINCYCLES_CTRL             = 8'h80,
    ADDR_AXI00_PTR0_DATA_0             = 8'h84,
    ADDR_AXI00_PTR0_DATA_1             = 8'h88,
    ADDR_AXI00_PTR0_CTRL               = 8'h8c,
    WRIDLE                             = 2'd0,
    WRDATA                             = 2'd1,
    WRRESP                             = 2'd2,
    WRRESET                            = 2'd3,
